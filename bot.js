...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please Wait.')}`);
    ...
    Lilly-mwol2.0CN.on('open', async () => {
        ...
        console.log(chalk.bgGreen('🐺 Lilly-mwol2.0' + afwhasena));
        await new Promise(r => setTimeout(r, 500));
        let EVA_ACTİON = config.LANG == 'TR' || config.LANG == 'AZ' ? '*Lilly-mwol2.0 Chatbot Olarak Çalışıyor!* 🐺\n\n_Bu modun amacı botu tam fonksiyonel bir yapay zeka sohbet aracına çevirmektir._\n_Normal moda dönmek için_ *.fulleva off* _komutunu kullanabilirsiniz._\n\n*Lilly-mwol2.0 Kullandığın İçin Teşekkürler 💌*\n    *- Eva*' : '*Lilly-mwol2.0 Working as a Chatbot! 🐺*\n\n_The purpose of this mod is to turn the bot into a fully functional AI chatbot._\n_You can use the_ *.fulleva off* _command to return to normal mode._\n\n*Thanks For Using Lilly-mwol2.0 💌*\n    *- Eva*'
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                if (error.message.includes('URL')) {
                                    return await Lilly-mwol2.0CN.sendMessage(Lilly-mwol2.0CN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [Lilly-mwol2.0] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                    ...
                                    return await Lilly-mwol2.0CN.sendMessage(Lilly-mwol2.0CN.user.jid, '*🙇🏻 Maalesef Bu Hatayı Okuyamadım! 🙇🏻*' +
                                ...
                                if (error.message.includes('URL')) {
                                    return await Lilly-mwol2.0CN.sendMessage(Lilly-mwol2.0CN.user.jid, '*⚕️ ERROR ANALYSIS [Lilly-mwol2.0] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                    ...
                                    return await Lilly-mwol2.0CN.sendMessage(Lilly-mwol2.0CN.user.jid, '*🙇🏻 Sorry, I Couldnt Read This Error! 🙇🏻*' +
